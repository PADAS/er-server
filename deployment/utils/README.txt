...
MAC-JayL-2:utils jayl$ curl -w "@curl-format.txt" -o /dev/null -H "Authorization: Bearer <bearer token>" -s https://garamba.pamdas.org/api/v1.0/subjects?bbox=29.18380737304688,4.050576786133467,29.81552124023438,4.282734218104703
...
MAC-JayL-2:utils jayl$ curl -w "@curl-format.txt" -o /dev/null -H "Authorization: Bearer <bearer token>" -s https://garamba.apn.pamdas.org/api/v1.0/subjects?bbox=29.18380737304688,4.050576786133467,29.81552124023438,4.282734218104703
