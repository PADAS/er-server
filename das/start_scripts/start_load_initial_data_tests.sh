...
python manage.py loaddata_with_tenant --tenant_domain "$TENANT_DOMAIN" initial_admin_tests initial_groups initial_eventdata initial_dev_map initial_features initial_tilelayers event_data_model
