    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        max_length=100, unique=True, verbose_name="A friendly, unique name for the analyzer."
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Designates whether this Schedule is active. Set this False instead of deleting this record.",
                        verbose_name="active",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("values", django.db.models.JSONField(blank=True, default={})),
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="_subjectanalyzerresult_observations_+", to="observations.Observation"
                    ),
                ),
                ("subject", models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="observations.Subject")),
                (
                    "subject_analyzer_content_type",
