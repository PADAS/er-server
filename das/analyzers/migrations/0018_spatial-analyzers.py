    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "search_time_hours",
                    models.FloatField(default=24.0, verbose_name="The period over which to run the subject analyzer"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("updated_at", models.DateTimeField(auto_now=True)),
                ("id", models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ("percentiles", django.db.models.JSONField(blank=True, default={})),
            ],
            options={
                "abstract": False,
            },
