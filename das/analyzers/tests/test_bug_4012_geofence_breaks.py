...
class TestBug4012(TestCase):
    ...
    def test_geofence_bug4012(self):
        ...
        primary_group = SpatialFeatureGroupStatic.objects.create(
            name="DAS 4022 Geofences",
        )
        ...
        warning_group = SpatialFeatureGroupStatic.objects.create(
            name="DAS 4022 Secondary Geofences",
        )
        ...
        GeofenceAnalyzerConfig.objects.create(
            subject_group=sg,
            critical_geofence_group=primary_group,
