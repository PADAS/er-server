...
class FeatureProximityAnalyzerAdmin(BaseModelAdminMixin):
    ...
    fieldsets = (
        ...
        ("Spatial Features", {"classes": ("wide",), "fields": (("proximal_features",))}),
        (
            "Advanced Analyzer Attributes",
            {
                "classes": ("wide", "collapse"),
...
class GlobalForestWatchAdmin(OSMGeoExtendedAdmin):
    ...
    fieldsets = (
        (None, {"classes": ("wide",), "fields": ("name", "last_check_time", "last_check_status")}),
        (
        ...
        (
            "Advanced Attributes",
            {"classes": ("wide", "collapse"), "fields": ("id", "additional", "glad_confirmed_backfill_days")},
        ),
        ("Global Forest Watch Alerts Confidence Level", {"fields": ("Deforestation_confidence", "Fire_confidence")}),
        ("Geographical Area", {"fields": ("subscription_geometry",)}),
    )
