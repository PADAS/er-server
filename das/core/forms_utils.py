...
class ColorPickerWidget(TextInput):
    ...
    class Media:
        css = {"all": ("{}css/bootstrap-colorpicker.css".format(settings.STATIC_URL),)}
        js = (
...
class AssignedDateTimeRangeWidget(MultiWidget):
    ...
    def decompress(self, value):
        ...
        return [DEFAULT_ASSIGNED_RANGE[0], DEFAULT_ASSIGNED_RANGE[1]]
...
class AssignedDateTimeRangeField(MultiValueField):
    def __init__(self, **kwargs):
        ...
        super().__init__(
            ...
            widget=AssignedDateTimeRangeWidget(),
            **kwargs,
        )
