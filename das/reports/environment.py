...
from jinja2.compiler import CodeGenerator, generate
...
from jinja2.lexer import TokenStream, get_lexer
from jinja2.nodes import EvalContext
from jinja2.optimizer import optimize
from jinja2.parser import Parser
from jinja2.runtime import Context, Undefined, new_context
from jinja2.utils import LRUCache, concat, consume, import_string, internalcode, missing
from markupsafe import Markup
from six import PY2, iteritems, reraise, string_types, text_type
...
def _environment_sanity_check(environment):
    ...
    assert environment.block_start_string != environment.variable_start_string != environment.comment_start_string, (
