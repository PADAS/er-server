...
class TestReportUtils(TestCase):
    ...
    def test_tableau_urls(self):
        assert is_url_resolved("reports/tableau-dashboards/default/", views.TableauDashboard)
    ...
    def test_render_eventdetails(self):
        ...
        ser = EventSerializer(data=edata, context={"request": request})
