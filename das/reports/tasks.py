...
def alert_lag_delay(self):
    ...
    for provider in providers:
        ...
        if check_source_provider_lag_exceeded(provider_lag_check_data, provider_lag_config):
            send_lag_delay_alert(provider_lag_check_data, provider_lag_config)
...
def send_lag_delay_alert(provider_lag_check_data, provider_lag_config):
...
Average delay: {avg_lag}
    ...
    send_report(subject=message_subject,
                to_email='jaredw@vulcan.com', text_content=email_body)
