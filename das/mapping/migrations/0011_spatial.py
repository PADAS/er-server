    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("attributes", django.db.models.JSONField(default=dict)),
                ("provenance", django.db.models.JSONField(default=dict)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("data", django.db.models.JSONField(default={})),
                (
                    "user",
                    revision.manager.UserField(
                        ...
                        related_name="_spatialfeature_revision",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("attribute_schema", django.db.models.JSONField(default=dict)),
                ("presentation", django.db.models.JSONField(default=dict)),
                ("provenance", django.db.models.JSONField(default=dict)),
                ("external_id", models.CharField(blank=True, max_length=100, null=True, unique=True)),
                ("external_source", models.CharField(blank=True, max_length=25)),
                (
                    "display_category",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="mapping.DisplayCategory"),
                ),
                (
                    "tags",
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        primary_key=True,
                        serialize=False,
                        to="mapping.SpatialFeatureGroup",
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            name="feature_type",
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="mapping.SpatialFeatureType"),
        ),
        ...
        migrations.AddField(
            ...
            name="features",
            field=models.ManyToManyField(blank=True, related_name="groups", to="mapping.SpatialFeature"),
        ),
    ]
