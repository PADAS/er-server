...
from mapping.forms import (
    ArcgisConfigurationForm,
    DisplayCategoryForm,
    MapCenterForm,
    SpatialFeatureGroupStaticForm,
    SpatialFeatureTypeForm,
    TileLayerFormWithAttributes,
)
...
class TileLayerAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            ...
            {"classes": ("wide",), "fields": (("type", "title", "url", "icon_url", "configuration"))},
        ),
        (
    ...
    def get_attributes(self, instance):
        context = dict(
            (k, instance.attributes[k]) for k in ("type", "title", "url", "configuration") if k in instance.attributes
        )
...
class SpatialFeatureAdmin(BaseFeatureAdmin):
    ...
    inlines = (SpatialFeaturesInline,)
    fieldsets = (
        (None, {"fields": ("id", "name", "feature_type", "spatialfile", "feature_geometry")}),
        (
            "Advanced Attributes",
            {
                "classes": ("wide", "collapse"),
    ...
    def get_queryset(self, request):
        ...
        qs = qs.annotate(geometry_type=RawSQL("""geometryType(feature_geometry)""", ()))
        return qs
...
class BaseSpatialFileAdmin(admin.ModelAdmin):
    ...
    def get_actions(self, request):
        ...
        actions["delete_selected"] = (delete_selected_spatialfiles, "delete_selected", "Delete selected spatial files")
        return actions
...
class ArcgisConfigurationAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("ArcGIS Group", {"classes": ("wide", "groups"), "fields": ("groups",)}),
        (
            "Optional Attributes",
            {
                "classes": ("collapse",),
    ...
    def get_actions(self, request):
        ...
        actions["delete_selected"] = (
            self.delete_selected_arcgisconfigs,
            "delete_selected",
    ...
    def response_add(self, request, obj, post_url_continue=None):
        ...
        if self.arcgis_config(request) or not groups_found:
            ...
            redirect_url = add_preserved_filters(
                {"preserved_filters": preserved_filters, "opts": obj._meta}, request.path
            )

            params = {"config_name": obj.config_name, "search_text": obj.search_text, "username": obj.username}
