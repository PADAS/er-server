...
from mapping import models, spatialfile_utils
...
def automate_download_features_from_wfs():
    feature_services = models.ArcgisConfiguration.objects.filter(groups__isnull=False)
        ...
        try:
            with transaction.atomic():
                if member.type == "Feature Service":
                    ...
                    datetime.fromtimestamp(int(member.modified / 1000), timezone.utc)
