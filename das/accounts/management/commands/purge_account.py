...
class PurgeAccount(PurgeBase):
    ...
    def remove_user(self, user):
        ...
        self.delete_qs(oauth_models.get_access_token_model().objects.filter(user_id=pk))
        self.delete_qs(oauth_models.get_refresh_token_model().objects.filter(user_id=pk))
