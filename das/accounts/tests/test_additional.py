...
class AdditionalTestCase(TestCase):
    ...
    def test_additional_data_fields(self):
        ...
        additional_data["expiry"] = expiry.astimezone(pytz.timezone("UTC")).isoformat()
        additional_data["moudatesigned"] = mou_date_signed.astimezone(pytz.timezone("UTC")).isoformat()
