# Generated by Django 3.2.19 on 2023-09-27 21:26
import logging
...
def populate_tenant_into_models(apps, schema_editor):
    models_names = ["FileContentRevision", "ImageFileContentRevision"]
    class_models = [apps.get_model("usercontent", model_name) for model_name in models_names]
