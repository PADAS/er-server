"""Batched vector tile cache invalidation for observation segment tiles.

Signal handlers live in ``signals_segments_cache``; that module is not imported at app
startup so request workers and Celery do not register Redis-scanning post_save hooks.
This module is safe to import from Celery prerun cleanup and tests.
"""
