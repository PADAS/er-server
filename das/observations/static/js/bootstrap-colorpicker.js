...
var Color = function (_tinycolor) {
  ...
  _createClass(Color, [{
    ...
    value: function toString() {
      ...
      // return colorStr.replace('rgb(', '').replace(')','')
      return colorStr;
    }
  }]);
...
tinycolor.prototype = {
    ...
    toRawRgbString: function() {
        return (this._a == 1) ?
          "" + mathRound(this._r) + ", " + mathRound(this._g) + ", " + mathRound(this._b) :
          "" + mathRound(this._r) + ", " + mathRound(this._g) + ", " + mathRound(this._b) + ", " + this._roundA;
    ...
    toString: function(format) {
        ...
        if (format === "rawrgb") {
            formattedString = this.toRawRgbString();
        }
        if (format === "prgb") {
