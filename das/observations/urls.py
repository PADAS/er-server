...
urlpatterns = [
    ...
    re_path(r"^subjects/kml/?$", views.KmlSubjectsView.as_view(), name="subjects-kml-view"),
    ...
    re_path(r"^region/(?P<slug>[a-z0-9-]+)/subjects/?$", views.RegionSubjectsView.as_view()),
    re_path(
        r"^subjects/geojson/?$",
        views.SubjectsGeoJsonView.as_view(),
        name="subjects-geojson-view",
    ),
    re_path(r"^subjects/?$", views.SubjectsView.as_view(), name="subjects-list-view"),
    re_path(
    ...
    re_path(rf"^subject/(?P<id>{regex.UUID})/sources/?$", views.SubjectSourcesView.as_view()),
    re_path(
    ...
    re_path(r"^trackingmetadata/export/?$", views.TrackingMetaDataExportView.as_view()),
    re_path(
    ...
    re_path(rf"^messages/(?P<id>{regex.UUID})/?$", views.MessageView.as_view()),
    re_path(
        r"^news/?$",
