...
def load_subject_types(apps, schema_editor):
    ...
    python._get_model = partial(_get_model, apps)
    try:
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("value", models.CharField(max_length=40, primary_key=True, serialize=False, unique=True)),
                ("display", models.CharField(blank=True, max_length=100, verbose_name="Subject Type")),
        ...
        migrations.RunSQL(sql=CREATE_MISSING_SUBJECT_TYPES, reverse_sql=migrations.RunSQL.noop),
        migrations.RunSQL(sql=CREATE_MISSING_SUBJECT_SUBTYPES, reverse_sql=migrations.RunSQL.noop),
        ...
        migrations.AlterField(
            ...
            name="subject_subtype",
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to="observations.SubjectSubType"),
        ),
