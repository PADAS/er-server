...
class ObservationTestCase(BaseAPITest, xmlunittest.XmlTestMixin):
    observation_data = [(1, 1, 1508520145), (1, 2, 1508520146), (2, 2, 1508520147)]
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            "all_perms_user", "das_all_perms@vulcan.com", "all_perms_user", last_name="Last", first_name="First"
        )
        ...
        self.elephant_1 = Subject.objects.create_subject(
            id="d2ed403e-9419-41aa-8fa9-45a70e5ce2ef",
            name="Elephant 1",
            subject_subtype_id="elephant",
            additional={"region": "Region 1", "country": "USA", "rgb": "220,30,30"},
        )
        self.elephant_2 = Subject.objects.create_subject(
            id="c25e17d0-0337-4f0c-9274-25e5ae4da7c8",
            name="Elephant 2",
            subject_subtype_id="elephant",
            additional={"region": "Region 1", "country": "USA"},
        )
        self.elephant_3 = Subject.objects.create_subject(
            id="a873e49c-1cb5-4ad4-b29d-e4b8931036ba",
            name="Elephant 3",
            subject_subtype_id="elephant",
        ...
        self.view_subject_perm = Permission.objects.get(codename="view_subject")
    ...
    def test_root_kml_passes_filters_to_subjects_url(self):
        url = reverse("subjects-kml-root-view")
        kml_filters = {"start": "2017-06-12", "end": "2019-06-12", "include_inactive": "true"}
    ...
    def test_not_passing_include_inactive_filter_returns_only_active_subjects(self):
        ...
        with kmz.open("document.kml") as response_kml_bytes:
            response_kml = response_kml_bytes.read()
        response_kml_str = response_kml.decode("utf-8")
        urls = re.findall(r'http://testserver[\'"]?([^\'" <]+)', response_kml_str)
    ...
    def test_wrong_date_format_returns_400(self):
        url = reverse("subjects-kml-root-view")
        url += "?{}".format(urlencode({"start": "2018-2008-13T05:11:29.096844Z", "end": "2018-08-13T05:11:29.096844Z"}))
