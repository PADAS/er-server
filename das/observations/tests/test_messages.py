...
class MessagesTestCase(BaseAPITest):
    ...
    def test_messaging_in_subject_payload(self, mock_send):
        ...
        assert (
            messaging.get("url")
            == "http://testserver/api/v1.0/messages?subject_id=269524d5-a434-4377-9ea9-2a7946dbd9c4&source_id=56b1cf14-ef97-4054-8fbd-1342f265b2a9"
        )
    ...
    @mock.patch("observations.tasks.handle_outbox_message.apply_async")
    def test_message_permission(self, mock_send, get_tenant_settings):
    ...
    def test_smart_integrate_adapter(self, mock_request):
        ...
        messaging_config = {
            "url": "https://cdip-api.pamdas.org/messages",
