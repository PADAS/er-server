...
INSTALLED_APPS = (
    tuple(itertools.takewhile(lambda x: x != "django.contrib.staticfiles", INSTALLED_APPS))
    + ("debug_toolbar",)
    + tuple(itertools.dropwhile(lambda x: x != "django.contrib.staticfiles", INSTALLED_APPS))
)
...
CORS_ALLOWED_ORIGINS = ("http://127.0.0.1:9000", "http://localhost:9000", "http://localhost:8000")
