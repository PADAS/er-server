...
app.conf.task_routes = {
    ...
    'rt_api.tasks.handle_new_patrolsegment': {'queue': 'realtime_p2', },
    'rt_api.tasks.handle_update_patrolsegment': {'queue': 'realtime_p2', },
    'rt_api.tasks.handle_delete_patrolsegment': {'queue': 'realtime_p3', },
