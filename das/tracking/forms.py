...
def list_of_plugins():
    for cls in (SavannahPlugin, AWETelemetryPlugin, AwtPlugin, SkygisticsSatellitePlugin,
                FirmsPlugin, SpiderTracksPlugin, InreachKMLPlugin, InreachPlugin, VectronicsPlugin, SirtrackPlugin,
                ):
...
class SourcePluginForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['plugin_choice'].choices = sorted([self._encode_plugin_identifier(obj) for obj in list_of_plugins()], key=lambda x: x[1])
