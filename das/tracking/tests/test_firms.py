...
class TestSirtrack(TestCase):
    ...
    def test_calculate_date_indexes_from_cached_headers(self):

        f = FirmsClient()

        cached_headers = json.loads(CACHED_HEADERS_1)
...
"accept-ranges": "bytes", "last-modified": "Sun, 14 Jan 2019 23:00:52 GMT", "content-length": "2897324",
 ...
 "content-disposition": "attachment;  filename=VIIRS_I_Northern_and_Central_Africa_VNP14IMGTDL_NRT_%s.txt;", 
 "strict-transport-security": "max-age=31536000; includeSubDomains",
  "access-control-allow-credentials": "true"}}
'''.format(dateindex=dateindex)
