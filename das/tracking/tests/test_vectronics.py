...
class VectronicsPluginTest(TestCase):
    ...
    def setUp(self):
        collar_key = "6484B8CA88E2B996421AB903D0B215AFAE285CAAE932F35F44815439"\
        ...
        self.source = Source.objects.create(
            provider=self.source_provider, manufacturer_id='1000001',
            source_type=('tracking-device', 'Tracking Device'),
            additional=additional_data)

        vectronic_plugin = VectronicsPlugin.objects.create(
            name='Vectronics', provider=self.source_provider)
