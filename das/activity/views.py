...
from activity.permissions import (
    ...
    IsEventProviderOwnerPermission,
    IsOwner,
...
class EventTypeSchemaView(generics.ListCreateAPIView):
    ...
    def get(self, request, *args, **kwargs):
        eventtype = generics.get_object_or_404(EventType.objects.all(), value__iexact=self.kwargs["eventtype"])
        ...
        schema["schema"]["image_url"] = utils.add_base_url(request, eventtype.image_url)
...
class EventNotesView(generics.ListCreateAPIView):
    ...
    def get_event(self):
        event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs.get("id"))
        return event
...
class EventFilesView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs["id"])
...
class EventFileView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_queryset(self):
        event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs.get("event_id"))
...
class EventRelationshipsView(generics.ListCreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        from_event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs["from_event_id"])

        to_event = generics.get_object_or_404(Event.objects.all(), pk=request.data.get("to_event_id"))
    ...
    def get_queryset(self):
        event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs.get("from_event_id"))
...
class EventRelationshipView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def delete(self, request, *args, **kwargs):
        ...
        to_event = generics.get_object_or_404(Event.objects.all(), pk=self.kwargs["to_event_id"])
...
class PatrolNotesView(generics.ListCreateAPIView):
    ...
    def get_patrol(self):
        return generics.get_object_or_404(Patrol.objects.all(), pk=self.kwargs.get("id"))
...
class PatrolFileView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_queryset(self):
        return PatrolFile.objects.all().filter(
            patrol=generics.get_object_or_404(Patrol.objects.all(), pk=self.kwargs.get("id"))
        )
