    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', activity.manager.UserField(editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='_event_revision', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'default_permissions': (),
            },
