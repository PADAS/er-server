    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "serial_number",
                    models.BigIntegerField(blank=True, null=True, unique=True, verbose_name="Serial Number"),
                ),
                (
                    "priority",
                    models.PositiveSmallIntegerField(
                        choices=[(0, "Gray"), (100, "Green"), (200, "Amber"), (300, "Red")], default=0
                    ),
                ),
                (
                    "state",
                    models.PositiveSmallIntegerField(
                        choices=[("upcoming", "Upcoming"), ("active", "Active"), ("past", "Past")], default="active"
                    ),
                ),
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        related_name="patrol_assignments",
                ...
                (
                    ...
                    models.ForeignKey(
                        limit_choices_to=models.Q(
                            models.Q(("app_label", "usercontent"), ("model", "filecontent")),
            ...
            fields=[
                ...
                (
                    ...
                    revision.manager.UserField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="_patrolsegment_revision",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    revision.manager.UserField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="_patrolnote_revision",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    revision.manager.UserField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="_patrolfile_revision",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
