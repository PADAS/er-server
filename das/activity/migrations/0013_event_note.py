        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "action",
                    models.CharField(
                        choices=[("added", "Added"), ("updated", "Updated"), ("deleted", "Deleted")],
                        default="added",
                        max_length=10,
                    ),
                ),
                ...
                (
                    ...
                    revision.manager.UserField(
                        ...
                        related_name="_eventattachment_revision",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "created_by_user",
                    models.ForeignKey(
                        null=True, on_delete=models.SET(activity.models.get_sentinel_user), to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    revision.manager.UserField(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="_eventnote_revision",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
