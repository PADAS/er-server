...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="priority",
            field=models.PositiveSmallIntegerField(
                choices=[(0, "Gray"), (100, "Green"), (200, "Amber"), (300, "Red")], default=100
            ),
        ),
        migrations.AlterField(
            model_name="eventfilter",
            name="filter_spec",
            field=django.db.models.JSONField(default=dict, verbose_name="Filter specification"),
        ),
        migrations.AlterField(
            model_name="eventnotification",
            name="method",
            field=models.CharField(
                choices=[("email", "Email"), ("sms", "SMS"), ("whatsapp", "WhatsApp")], default="email", max_length=20
            ),
        ),
        migrations.AlterField(
